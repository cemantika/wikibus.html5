...
Ext.define('Ubibus.view.PontoDetalhe', {
    ...
    onOpcoesOnibusToggle: function(segmentedbutton, button, isPressed, options) {
    ...
    onTxtNumeroLinhaKeyup: function(textfield, e, options) {
    ...
    onTxtNumeroLinhaClearicontap: function(text, e, options) {
        var store = Ext.getCmp('listalinhas').getStore();
        store.clearFilter();
