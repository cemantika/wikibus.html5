    ...
    salvarUsuario: function(button, e, eOpts) {
      ...
      //Avalia se todos os campos foram preenchidos
        ...
        //Avalia se o dado inserido em "Confirmar Senha" confere com o de "Senha"
        	...
        	Ext.getCmp('lblUsuarioStatus').setHtml('A Confirma��o de Senha n�o confere com a Senha!');
            ...
            Ext.Ajax.request({
                ...
                callback: function(options, success, response) {
                    ...
                    //Se o email n�o existe ele insere o usuario
                    if (resp == "NOT_FOUND"){
                    ...
                    //Se o email existe ele n�o insere e retorna o aviso
                    }else{
